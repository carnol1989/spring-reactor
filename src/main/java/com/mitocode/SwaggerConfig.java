...
public class SwaggerConfig { 
	...
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("MitoREST WebFlux Api Documentation",
			"MitoREST WebFlux Api Documentation", "1.0", "PREMIUM", DEFAULT_CONTACT, "Apache 2.0",
